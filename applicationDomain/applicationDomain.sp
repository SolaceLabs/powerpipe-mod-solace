dashboard "application_domain" {
  ...
  graph {
    title = "Application Domain Graph"
  ...
  flow {
    title = "Application Domain Flow"

    node f_domains {
      category = category.f_application_domain
    ...
    node f_applications {
      category = category.f_application
    ...
    node f_application_version {
      category = category.f_application_version
    ...
    edge f_application_to_applicationversion {
      category = category.f_application
      sql = <<-EOQ
        SELECT a.id AS from_id, b.id AS to_id
          FROM solace_application AS a
    ...
    node f_event_version {
      category = category.f_event_version
    ...
    edge f_applicationversion_to_eventversion {
    ...
    node f_enum_version {
      category = category.f_enum_version
    ...
    edge f_enumversion_to_eventversion {
      sql = <<-EOQ
        select env.id as from_id, ev.id as to_id
          from solace_application a,
                solace_application_version av,
    ...
    node f_schema_version {
      category = category.f_schema_version
    ...
    edge f_schema_to_schemaversion {
      sql = <<-EOQ
        select b.id as from_id, a.id as to_id
          from solace_schema_version a, solace_schema b
          where b.application_domain_id = $1 and a.schema_id = b.id
    ...
    edge f_schemaversion_to_eventversion {
      sql = <<-EOQ
        select sv.id as from_id, ev.id as to_id
          from solace_application a,
                solace_application_version av,
    ...
    node f_eventapi_version {
      category = category.f_eventapi_version
    ...
    edge f_eventapiversion_to_eventapi {
      category = category.f_eventapi_version
    ...
    edge f_eventversion_to_eventapiversion {
      category = category.f_eventapi_version
...
category "f_application_domain" {
  color = "#ff0000"
  icon = "https://docs.solace.com/Resources/Images/Event-Portal/graph-icons/graph-app-domain.png"
}

category "f_application" {
  color = "#ff8700"
  icon = "https://docs.solace.com/Resources/Images/Event-Portal/graph-icons/graph-application.png"
}

category "f_application_version" {
  title = "Application Version"
  color = "#ff8700"
  icon = "https://docs.solace.com/Resources/Images/Event-Portal/graph-icons/graph-application.png"
}
...
category "f_eventapi_version" {
  title = "EventAPI Version"
  icon = "https://cdn-icons-png.freepik.com/512/7549/7549551.png"
  color = "#147df5"
}

category "f_eventapi_product" {
  title = "EventAPI Product"
  icon = "https://cdn-icons-png.freepik.com/512/10169/10169724.png"
  color = "#580aff"
}

category "f_eventapi_product_version" {
  title = "EventAPI Product Version"
  icon = "https://cdn-icons-png.freepik.com/512/10169/10169724.png"
  color = "#580aff"
}